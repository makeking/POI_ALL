...
//				sheet.mergeCells()
                ...
                for (int j = 0; j < objList.size(); j++) {
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        sheet.addCell(new Label(i, j + 1, String.valueOf(list.get(i)), arial12format));
    ...
    public static  void getDataCreateChart(){

    }

    public static void writePng(String name, String pngPath, int x, int y) {
        WritableWorkbook writebook = null;
        InputStream in = null;
        try {
            WorkbookSettings setEncode = new WorkbookSettings();

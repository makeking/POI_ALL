...
public class PdfDomainVO {
    ...
    public PdfDomainVO(Integer id, Date time, String filename, String filesize, String filetype, String details, String content, String outputfile, String inputfile, String strtofind, String message, String imagefile, String imagelist, Integer pageno, Integer pages, Integer rid, Integer pageoperation, Integer pagestart, Integer pageend, String position, String fileSizeAfter, Integer status, Integer afterPages, Integer imgSize) {
        this.id = id;
        this.time = time;
